...
export const TESTIMONIALS = [
  {
    quote:
      "Splitely has revolutionized how I manage expenses with my co-stars during film shoots. No more confusion about who paid for what!",
    name: "Rajinikanth",
    image: "/testimonials/rajini.jpg",
    role: "Superstar Actor",
  },
  {
    quote:
      "As someone who's always traveling for shoots, Splitely makes it incredibly easy to split travel and accommodation costs with the crew.",
    name: "Vijay",
  ...
  {
    quote:
      "Splitely's AI categorization is so smart! It perfectly tracks all our production expenses and keeps everyone accountable.",
    name: "Suriya",
    image: "/testimonials/suriya.jpg",
    role: "Actor & Producer",
  },
];
